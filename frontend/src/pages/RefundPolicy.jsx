  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 bg-gray-900 text-white shadow-lg rounded-lg mt-10">
      ...
      <p className="text-gray-300">
        ...
        Such cases must be reported to our support team within 7 days of the transaction. The refund would be processed and credited to original payment method within 7 working days.
      </p>
